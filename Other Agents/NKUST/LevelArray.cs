...
namespace GeometryFriendsAgents
{
    public class LevelArray
    {
        ...
        public void getRectPlant(RectangleRepresentation k)
        {
            int xPosArray = (int)(k.X - (10000/k.Height / 2) - GameInfo.LEVEL_ORIGINAL) / PIXEL_LENGTH;
            int yPosArray = (int)(k.Y - (k.Height / 2) - GameInfo.LEVEL_ORIGINAL) / PIXEL_LENGTH;
            int height = (int)(k.Height / PIXEL_LENGTH);
            int width = (int)(10000 / k.Height / PIXEL_LENGTH);
        ...
        public void removeRectPlant(RectangleRepresentation k)
        {
            int xPosArray = (int)(k.X - (10000 / k.Height / 2) - GameInfo.LEVEL_ORIGINAL) / PIXEL_LENGTH;
            int yPosArray = (int)(k.Y - (k.Height / 2) - GameInfo.LEVEL_ORIGINAL) / PIXEL_LENGTH;
            int height = (int)(k.Height / PIXEL_LENGTH);
