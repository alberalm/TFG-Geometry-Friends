...
namespace GeometryFriendsAgents
{
    public class DiamondInfo
    {
        ...
        private void getAreas(int[,] levelLayout)
        {
            ...
            smallArea.Add(new Area(leftX, rightX, topY, bottomY));
            ...
            bigArea.Add(new Area(leftX, rightX, topY, bottomY));
        ...
        private void expandArea(Area area, List<Area> areas, int radius, int[,] levelLayout)
        {
            ...
            Area newArea = new Area(newLX, newRX, newTY, newBY);
