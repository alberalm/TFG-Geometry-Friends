...
namespace GeometryFriendsAgents
{
    class MoveInformation
    {
        ...
        public int Compare(MoveInformation other, CollectibleRepresentation[] initialCollectiblesInfo)
        {
            ...
            if (LevelMap.Contained(diamondsCollected, other.diamondsCollected) && LevelMap.Contained(other.diamondsCollected, diamondsCollected)) //diamondsCollected=other.diamondsCollected
            {
            ...
            else if (LevelMap.Contained(diamondsCollected, other.diamondsCollected) && !LevelMap.Contained(other.diamondsCollected, diamondsCollected))//diamondsCollected strictly contained in other.diamondsCollected
            {
                return -1;
            }
            else if (!LevelMap.Contained(diamondsCollected, other.diamondsCollected) && LevelMap.Contained(other.diamondsCollected, diamondsCollected))//other.diamondsCollected strictly contained in diamondsCollected
            {
                return 1;
            }
            else if (!LevelMap.Contained(diamondsCollected, other.diamondsCollected) && !LevelMap.Contained(other.diamondsCollected, diamondsCollected))//Incomparable
            {
                return 0;
            }
            return 0;
