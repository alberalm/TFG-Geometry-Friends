...
namespace GeometryFriendsAgents
{
    ...
    public class CircleAgent : AbstractCircleAgent
    {
        ...
        private int target_velocity=-GameInfo.VELOCITY_STEP;
        ...
        private void CircleDraw()
        {
            ...
            newDebugInfo.Add(DebugInformationFactory.CreateCircleDebugInfo(new PointF(target_position*GameInfo.PIXEL_LENGTH, circleInfo.Y), 4, GeometryFriends.XNAStub.Color.Orange));

            newDebugInfo.Add(DebugInformationFactory.CreateTextDebugInfo(new PointF(600, 600), "Velocidad: "+circleInfo.VelocityX, GeometryFriends.XNAStub.Color.Orange));
            newDebugInfo.Add(DebugInformationFactory.CreateTextDebugInfo(new PointF(600, 700), "Velocidad objetivo: " + target_velocity, GeometryFriends.XNAStub.Color.Orange));
        }
        ...
        public override void Update(TimeSpan elapsedGameTime)
        {
            ...
            if (t > 1)
            {
                State s = new State(((int)(circleInfo.X / GameInfo.PIXEL_LENGTH)) - target_position, DiscreetVelocity(circleInfo.VelocityX), target_velocity);
